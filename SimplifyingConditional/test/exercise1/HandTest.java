...
public class HandTest {
	...
	public void testRoyalFlush() {
		...
		Assert.assertEquals(100000, hand.findMaxValueSubset(table));
	}
	...
	public void testStraightFlush() {
		...
		Assert.assertEquals(90000, hand.findMaxValueSubset(table));
	}
	...
	public void testFourOfKind() {
		...
		Assert.assertEquals(80000, hand.findMaxValueSubset(table));
	}
	...
	public void testFull() {
		...
		Assert.assertEquals(70000, hand.findMaxValueSubset(table));
	}
	...
	public void testFlush() {
		...
		Assert.assertEquals(60000, hand.findMaxValueSubset(table));
	}
	...
	public void testStraight() {
		...
		Assert.assertEquals(50000, hand.findMaxValueSubset(table));
	}
	...
	public void testThreeOfKind() {
		...
		Assert.assertEquals(40000, hand.findMaxValueSubset(table));
	}
	...
	public void testTwoPairs() {
		...
		Assert.assertEquals(30000, hand.findMaxValueSubset(table));
	}
	...
	public void testPair() {
		...
		Assert.assertEquals(20000, hand.findMaxValueSubset(table));
	}
	...
	public void testHighCard() {
		...
		Assert.assertEquals(11, hand.findMaxValueSubset(table));
	}
}
